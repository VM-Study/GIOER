...
let JwtAccessStrategy = JwtAccessStrategy_1 = class JwtAccessStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    configService;
    logger = new common_1.Logger(JwtAccessStrategy_1.name);
